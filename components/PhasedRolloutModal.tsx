...
const PHASES_DATA: RolloutPhase[] = [
  ...
  },
  {
    ...
    deliverables: [
      {
        title: 'Multi-Clinic Branch Switcher',
        description: 'Instant switching between clinic practices with isolated practitioner rosters and persistent branch tenancy in header and command palette.',
        isComplete: true,
        quickLinkTab: 'command-center',
      },
      {
        title: 'Offline-First Field Visit Mode',
      ...
      {
        title: 'IndexedDB Offline Cache Queue',
        description: 'Robust local store tracking pending create/update mutations with status badges and conflict resolution.',
        isComplete: true,
        quickLinkTab: 'command-center',
      },
    ],
    technicalArchitecture: [
      ...
      'Navigator.onLine event listeners with background sync dispatcher',
      'Service Worker offline caching for static assets and shell UI',
    ],
  },
  {
    phaseId: 3,

...
const PHASES_DATA: RolloutPhase[] = [
  ...
  },
  {
    ...
    status: 'DEPLOYED',
    progressPercent: 100,
    targetTimeline: 'October 2026 (Live)',
    icon: BrainCircuit,
  ...
  },
  {
    ...
    status: 'DEPLOYED',
    progressPercent: 100,
    targetTimeline: 'November 2026 (Live)',
    icon: Receipt,
  ...
  },
  {
    ...
    status: 'DEPLOYED',
    progressPercent: 100,
    targetTimeline: 'December 2026 (Live)',
    icon: Users,
    summary: 'Secure magic-link parent and carer portal with live Goal Attainment Scaling tracking, Easy Read accessibility mode, and WebRTC telehealth consultations.',
    deliverables: [
      {
        title: 'Secure Magic-Link Family Portal & Easy Read',
        description: 'Passwordless, zero-friction portal for parents, nominees, and support coordinators with accessible Easy Read visuals.',
        isComplete: true,
        quickLinkTab: 'clients',
      },
      {
        title: 'Integrated Telehealth Video Room & Live Dictation',
        description: 'Secure WebRTC video consultations with live in-call timer, camera/mic controls, and in-call case note scratchpad.',
        isComplete: true,
        quickLinkTab: 'clients',
      },
    ],
    technicalArchitecture: [
      ...
      'WCAG 2.1 AAA high-contrast accessibility color engine',
    ],
  },
  {
    phaseId: 6,
    ...
    deliverables: [
      {
        ...
        description: 'Bi-directional interoperability with hospital emergency department feeds, My Health Record, and standard FHIR R4 Bundles.',
        isComplete: true,
        quickLinkTab: 'audit',
      },
      {
        title: 'Custom White-Label Clinic Subdomains & Branding',
